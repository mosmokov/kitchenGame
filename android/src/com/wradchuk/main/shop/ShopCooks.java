...
public class ShopCooks implements Screen, AsyncResultPasser {
    ...
    public ShopCooks(Core _game) {
        ...
        cook_tab     = MyComponent.createImageButton("screen/shop/all_screen/cook_tab_on.png", "screen/shop/all_screen/cook_tab_on.png");
        sale_tab     = MyComponent.createImageButton("screen/shop/all_screen/sale_tab_off.png", "screen/shop/all_screen/sale_tab_on.png");
        recipe_tab   = MyComponent.createImageButton("screen/shop/all_screen/recipe_tab_off.png", "screen/shop/all_screen/recipe_tab_on.png");

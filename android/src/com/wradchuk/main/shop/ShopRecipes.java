...
public class ShopRecipes implements Screen {
    ...
    public ShopRecipes(final Core _game) {
        ...
        exit_button  =  MyComponent.createImageButton("screen/shop/all_screen/exit_button.png", "screen/shop/all_screen/exit_button.png");
        buy_button   =  MyComponent.createImageButton("screen/shop/all_screen/buy_button.png", "screen/shop/all_screen/buy_button.png");
        cook_tab     =  MyComponent.createImageButton("screen/shop/all_screen/cook_tab_off.png", "screen/shop/all_screen/cook_tab_on.png");
        sale_tab     =  MyComponent.createImageButton("screen/shop/all_screen/sale_tab_off.png", "screen/shop/all_screen/sale_tab_on.png");
        recipe_tab   =  MyComponent.createImageButton("screen/shop/all_screen/recipe_tab_on.png", "screen/shop/all_screen/recipe_tab_on.png");
        resources_tab = MyComponent.createImageButton("screen/shop/all_screen/resources_tab_off.png", "screen/shop/all_screen/resources_tab_on.png");

        up_arrow = MyComponent.createImageButton("screen/shop/all_screen/down_arrow.png", "screen/shop/all_screen/down_arrow.png");
        up_arrow.setRotation(180);
        down_arrow = MyComponent.createImageButton("screen/shop/all_screen/down_arrow.png", "screen/shop/all_screen/down_arrow.png");
        ...
        recipe_asia_1   = MyComponent.createImageButton("screen/shop/recipes/recipe_asia_1.png", "screen/shop/recipes/recipe_asia_1.png");
        recipe_asia_2   = MyComponent.createImageButton("screen/shop/recipes/recipe_asia_2.png", "screen/shop/recipes/recipe_asia_2.png");
        recipe_asia_3   = MyComponent.createImageButton("screen/shop/recipes/recipe_asia_3.png", "screen/shop/recipes/recipe_asia_3.png");
        recipe_europe_1 = MyComponent.createImageButton("screen/shop/recipes/recipe_europe_1.png", "screen/shop/recipes/recipe_europe_1.png");
        recipe_europe_2 = MyComponent.createImageButton("screen/shop/recipes/recipe_europe_2.png", "screen/shop/recipes/recipe_europe_2.png");
        recipe_europe_3 = MyComponent.createImageButton("screen/shop/recipes/recipe_europe_3.png", "screen/shop/recipes/recipe_europe_3.png");

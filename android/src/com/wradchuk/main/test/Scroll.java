...
public class Scroll {
    ...
    public void createButton() {
        if(bought) scroll_widget = MyComponent.createImageButton("json/scroll1.png", "json/scroll1.png");
        else scroll_widget = MyComponent.createImageButton("json/scroll0.png", "json/scroll0.png");
    }
    ...
    public void setCap() {
        if(state==2) {
           cap[0] = new Sprite(new Texture("json/cap1.png"));
           cap[1] = new Sprite(new Texture("json/cap0.png"));
           cap[2] = new Sprite(new Texture("json/cap0.png"));
        }
        else if(state==3) {
            cap[0] = new Sprite(new Texture("json/cap1.png"));
            cap[1] = new Sprite(new Texture("json/cap1.png"));
            cap[2] = new Sprite(new Texture("json/cap0.png"));
        }
        else if(state==4) {
            cap[0] = new Sprite(new Texture("json/cap1.png"));
            cap[1] = new Sprite(new Texture("json/cap1.png"));
            cap[2] = new Sprite(new Texture("json/cap1.png"));
        }
        else {
            cap[0] = new Sprite(new Texture("json/cap0.png"));
            cap[1] = new Sprite(new Texture("json/cap0.png"));
            cap[2] = new Sprite(new Texture("json/cap0.png"));
        }
